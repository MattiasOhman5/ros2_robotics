///
/// Auto-generated TCP server for optimizer: turtle_mpc
///
...
/// Port
/// Can be overriden by the user
const BIND_PORT_DEFAULT: u32 = 3320;
...
fn execution_handler(
    ...
    match initial_guess {
        ...
        Some(u0) => {
            if u0.len() != TURTLE_MPC_NUM_DECISION_VARIABLES {
    ...
    if parameter.len() != TURTLE_MPC_NUM_PARAMETERS {
...
fn main() {
    let matches = App::new("OpEn TCP Server [turtle_mpc]")
        .version("0.0.0")
        .author("John Smith")
